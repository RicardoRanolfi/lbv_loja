...
class OperatorsControllerTest < ActionController::TestCase
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post :create, operator: { dateniver: @operator.dateniver, matricula: @operator.matricula, nome: @operator.nome }
    end
  ...
  test "should update operator" do
    patch :update, id: @operator, operator: { dateniver: @operator.dateniver, matricula: @operator.matricula, nome: @operator.nome }
    assert_redirected_to operator_path(assigns(:operator))
  end
