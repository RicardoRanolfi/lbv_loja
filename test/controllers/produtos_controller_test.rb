...
class ProdutosControllerTest < ActionController::TestCase
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post :create, produto: { codigoproduto: @produto.codigoproduto, descicao: @produto.descicao, nome: @produto.nome }
    end
  ...
  test "should update produto" do
    patch :update, id: @produto, produto: { codigoproduto: @produto.codigoproduto, descicao: @produto.descicao, nome: @produto.nome }
    assert_redirected_to produto_path(assigns(:produto))
  end
