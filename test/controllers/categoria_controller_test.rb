...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { codigoproduto: @categorium.codigoproduto, descricao: @categorium.descricao, nome: @categorium.nome }
    end
  ...
  test "should update categorium" do
    patch :update, id: @categorium, categorium: { codigoproduto: @categorium.codigoproduto, descricao: @categorium.descricao, nome: @categorium.nome }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
